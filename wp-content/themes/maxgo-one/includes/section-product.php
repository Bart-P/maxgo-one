<?php if (carbon_get_post_meta(get_queried_object_id(), 'crb_product_show')): ?>
	<div class="w-[100vw] bg-light">
		<div class="container w-full h-full">
            ...
            <div class="grid grid-cols-7 grid-rows-3 h-full mb-10 text-xl">
                ...
                <div class="text-center my-auto p-4 col-start-1 col-span-2 space-y-5 max-w-[300px]">
                ...
                <div class="text-center my-auto p-4 col-span-2 space-y-5 max-w-[300px]">
                    <div class="text-primary">
                ...
                <div class="text-center my-auto p-4 mx-auto col-start-3 col-span-3 text-center space-y-5 max-w-[300px]">
                        <div class="text-primary">
